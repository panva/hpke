...
declare class SenderContext {
     ...
     */
    Export(exporter_context: Uint8Array, L: number): Promise<Uint8Array>;
    /**
...
export declare class CipherSuite {
     ...
     */
    SerializePrivateKey(private_key: Key): Promise<Uint8Array>;
    /**
     ...
     */
    SerializePublicKey(public_key: Key): Promise<Uint8Array>;
    /**
     ...
     */
    DeserializePrivateKey(private_key: Uint8Array, extractable?: boolean): Promise<Key>;
    /**
     ...
     */
    DeserializePublicKey(public_key: Uint8Array): Promise<Key>;
    /**
     ...
     */
    Seal(public_key: Key, plaintext: Uint8Array, aad?: Uint8Array, options?: {
        info?: Uint8Array;
        psk?: Uint8Array;
        psk_id?: Uint8Array;
    }): Promise<{
     ...
     * @returns A Promise that resolves to the decrypted plaintext.
     */
    Open(private_key: Key | KeyPair, encapsulated_key: Uint8Array, ciphertext: Uint8Array, aad?: Uint8Array, options?: {
        info?: Uint8Array;
        psk?: Uint8Array;
        psk_id?: Uint8Array;
    }): Promise<Uint8Array>;
     ...
     *   secret.
     */
    SendExport(public_key: Key, exporter_context: Uint8Array, L: number, options?: {
        info?: Uint8Array;
        psk?: Uint8Array;
        psk_id?: Uint8Array;
    }): Promise<{
        encapsulated_key: Uint8Array;
        exported_secret: Uint8Array;
    }>;
    /**
     ...
     * @returns A Promise that resolves to the exported secret.
     */
    ReceiveExport(private_key: Key | KeyPair, encapsulated_key: Uint8Array, exporter_context: Uint8Array, L: number, options?: {
        info?: Uint8Array;
        psk?: Uint8Array;
        psk_id?: Uint8Array;
    }): Promise<Uint8Array>;
     ...
     */
    SetupSender(public_key: Key, options?: {
        info?: Uint8Array;
        psk?: Uint8Array;
        psk_id?: Uint8Array;
    }): Promise<{
     ...
     */
    SetupRecipient(private_key: Key | KeyPair, encapsulated_key: Uint8Array, options?: {
        info?: Uint8Array;
        psk?: Uint8Array;
        psk_id?: Uint8Array;
