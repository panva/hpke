...
declare class SenderContext {
    #private;
    constructor(suite: Triple, mode: Mode, key: Uint8Array, base_nonce: Uint8Array, exporter_secret: Uint8Array);
    /**
 ...
 * @group Core
 */
export declare class CipherSuite<K extends Key = Key> {
    #private;
    /**
     ...
     */
    SerializePrivateKey(privateKey: K): Promise<Uint8Array>;
    /**
     ...
     */
    SerializePublicKey(publicKey: K): Promise<Uint8Array>;
    /**
     ...
     */
    DeserializePrivateKey(privateKey: Uint8Array, extractable?: boolean): Promise<K>;
    /**
     ...
     */
    DeserializePublicKey(publicKey: Uint8Array): Promise<K>;
    /**
     ...
     */
    Seal(publicKey: K, plaintext: Uint8Array, options?: {
        aad?: Uint8Array;
        info?: Uint8Array;
        psk?: Uint8Array;
        pskId?: Uint8Array;
     ...
     */
    Open(privateKey: K | KeyPair<K>, encapsulatedSecret: Uint8Array, ciphertext: Uint8Array, options?: {
        aad?: Uint8Array;
        info?: Uint8Array;
        psk?: Uint8Array;
        pskId?: Uint8Array;
     ...
     */
    SendExport(publicKey: K, exporterContext: Uint8Array, length: number, options?: {
        info?: Uint8Array;
        psk?: Uint8Array;
        pskId?: Uint8Array;
    }): Promise<{
     ...
     * @see [Single-Shot Secret Export](https://datatracker.ietf.org/doc/html/draft-ietf-hpke-hpke-04.html#section-6.2)
     */
    ReceiveExport(privateKey: K | KeyPair<K>, encapsulatedSecret: Uint8Array, exporterContext: Uint8Array, length: number, options?: {
        info?: Uint8Array;
        psk?: Uint8Array;
        pskId?: Uint8Array;
    }): Promise<Uint8Array>;
     ...
     */
    SetupSender(publicKey: K, options?: {
        info?: Uint8Array;
        psk?: Uint8Array;
        pskId?: Uint8Array;
    }): Promise<{
     ...
     */
    SetupRecipient(privateKey: K | KeyPair<K>, encapsulatedSecret: Uint8Array, options?: {
        info?: Uint8Array;
        psk?: Uint8Array;
        pskId?: Uint8Array;
 ...
 */
export declare const KEM_DHKEM_P256_HKDF_SHA256: KEMFactory<CryptoKey>;
/**
 ...
 * @see [HPKE KEM Identifiers](https://datatracker.ietf.org/doc/html/draft-ietf-hpke-hpke-04.html#section-7.1)
 */
export declare const KEM_DHKEM_P384_HKDF_SHA384: KEMFactory<CryptoKey>;
/**
 ...
 * @see [HPKE KEM Identifiers](https://datatracker.ietf.org/doc/html/draft-ietf-hpke-hpke-04.html#section-7.1)
 */
export declare const KEM_DHKEM_P521_HKDF_SHA512: KEMFactory<CryptoKey>;
/**
 ...
 * @see [HPKE KEM Identifiers](https://datatracker.ietf.org/doc/html/draft-ietf-hpke-hpke-04.html#section-7.1)
 */
export declare const KEM_DHKEM_X25519_HKDF_SHA256: KEMFactory<CryptoKey>;
/**
 ...
 * @see [HPKE KEM Identifiers](https://datatracker.ietf.org/doc/html/draft-ietf-hpke-hpke-04.html#section-7.1)
 */
export declare const KEM_DHKEM_X448_HKDF_SHA512: KEMFactory<CryptoKey>;
/**
 ...
 */
export declare const KEM_ML_KEM_512: KEMFactory<CryptoKey>;
/**
 ...
 * @see [HPKE-PQ KEM Identifiers](https://datatracker.ietf.org/doc/html/draft-ietf-hpke-pq-05.html#section-3)
 */
export declare const KEM_ML_KEM_768: KEMFactory<CryptoKey>;
/**
 ...
 * @see [HPKE-PQ KEM Identifiers](https://datatracker.ietf.org/doc/html/draft-ietf-hpke-pq-05.html#section-3)
 */
export declare const KEM_ML_KEM_1024: KEMFactory<CryptoKey>;
/**
