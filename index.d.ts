...
declare class SenderContext {
     ...
     */
    Export(exporterContext: Uint8Array, L: number): Promise<Uint8Array>;
    /**
...
export declare class CipherSuite {
     ...
     */
    Seal(publicKey: Key, plaintext: Uint8Array, aad?: Uint8Array, options?: {
        info?: Uint8Array;
        psk?: Uint8Array;
        pskId?: Uint8Array;
    }): Promise<{
     ...
     * @returns A Promise that resolves to the decrypted plaintext.
     */
    Open(privateKey: Key | KeyPair, encapsulatedKey: Uint8Array, ciphertext: Uint8Array, aad?: Uint8Array, options?: {
        info?: Uint8Array;
        psk?: Uint8Array;
        pskId?: Uint8Array;
    }): Promise<Uint8Array>;
     ...
     *   secret.
     */
    SendExport(publicKey: Key, exporterContext: Uint8Array, L: number, options?: {
        info?: Uint8Array;
        psk?: Uint8Array;
        pskId?: Uint8Array;
    }): Promise<{
     ...
     * @returns A Promise that resolves to the exported secret.
     */
    ReceiveExport(privateKey: Key | KeyPair, encapsulatedKey: Uint8Array, exporterContext: Uint8Array, L: number, options?: {
        info?: Uint8Array;
        psk?: Uint8Array;
        pskId?: Uint8Array;
    }): Promise<Uint8Array>;
